...
def main(hparams):
    ...
    data_dir = '/mnt/zhengxiaohu/IJCNN/predicts/'
    file_name = f'results_006_1.mat'
    path = data_dir + file_name
    data = {"ME_mean": ME_mean.numpy(), "RMSE_mean": RMSE_mean.numpy(), "MAE_mean":MAE_mean.numpy(), "MRE_mean":MRE_mean.numpy(), "R2_mean":R2_mean.numpy()}
